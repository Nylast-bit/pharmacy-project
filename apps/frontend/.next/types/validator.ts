...
// Validate ../../src/app/api/verify-admin/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/verify-admin">> = Specific
  const handler = {} as typeof import("../../src/app/api/verify-admin/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
